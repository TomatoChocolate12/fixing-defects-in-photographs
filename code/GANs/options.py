...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--model', type=str, default='ganimation',
                            help='[ganimation|stargan], see model.__init__ from more details.')
        ...
        parser.add_argument('--save_test_gif', action='store_true',
                            help='save gif images instead of the concatenation of static images.')
